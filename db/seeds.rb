...
challenge2 = Challenge.create!(title: "Who ya gonna call?",
                               tutorial: "Probably the Ghostbusters",
                               solution: "It's the Ghostbusters",
                               description: "They're paranormal detectives",
                               hint: "The fucking Ghostbusters")
